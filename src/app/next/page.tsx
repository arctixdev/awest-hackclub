...
export default function NextMeeting() {
    const date = "Oct 3 2024 15:30 GMT-0600";
    ...
    return (
        <div className="relative flex w-full h-screen flex-col items-center justify-center overflow-hidden rounded-lg bg-background">
            ...
            <span className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-blue-400 to-purple-300 bg-clip-text text-center text-8xl font-black leading-none text-transparent dark:from-blue-200 dark:to-purple-600">
